# -*- coding: utf-8 -*-
"""
Aim: To solve system of linear equation using Gauss Seidel method.
...
#Other questions which cant be solved 
...
if ddmtest(A):
    ...
    x=gaussSed(A,B,x)
    print("\nThe Solution using Gauss Seidel method")   
    for i in range(len(X)):
        print("{0} = {1} ".format(X[i][0],round(x[i]),4))
    
else:
    print("Cant be solved using Gauss Seidel method")
